#+TITLE: Lukkadd's GNU Emacs Config
#+AUTHOR: Lucca Del Debbio (Lukkadd)
#+DESCRIPTION: Lukkadd's personal Emacs config.
...
** Disable Menubar, Toolbars and Truncated Lines
#+BEGIN_SRC emacs-lisp
(menu-bar-mode -1)
(tool-bar-mode -1)
(scroll-bar-mode -1)
...
** Display Line Numbers and Scrollbars 
#+BEGIN_SRC emacs-lisp
...
"Directory Editor" is a directory manipulation tool. Allows me to add/rename/delete files and folders.
